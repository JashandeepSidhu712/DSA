...
class LinkedList //The LinkedList class manages the linked list operations.
{
    ...
    void insertAfterGivenPos(int value, int pos)
    {
        ...
        if(count==pos) //If the targetValue is found at the beginning (head) of the linked list
        {
        ...
        {
            cout<<"No target pos exists"<<endl;
        }
        else
        {
...
int main()
{
    ...
    int value, pos;
    cout<<"Enter value to insert and Enter position after which to insert=";
    cin>>value>>pos;
    
    obj.insertAfterGivenPos(value, pos);
